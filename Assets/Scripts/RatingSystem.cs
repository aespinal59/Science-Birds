...
public class RatingSystem : MonoBehaviour
{
    ...
    public class LSystemEvolution
    {
        ...
        public LSystemEvolution(LSystem lSystem)
        {
    ...
    private static bool isEvolution = false;
    public static bool IsEvolution => isEvolution;
    ...
    public static List<LSystemEvolution> keptForEvolution;
    ...
    void Awake()
    {
        ...
        keptForEvolution = new List<LSystemEvolution>();
    ...
    public static void GenerateXMLsForEvolution(int lSystemIndex, int height)
    {
        for (int i = 0; i < MAX_LEVELS; ++i)
        {
            //levelData[lSystemIndex].Add(new LevelData(XML));
            keptForEvolution[lSystemIndex].xmls.Add(keptForEvolution[lSystemIndex].lSystem.GenerateXML(height));
        }
    }
    ...
    public static void StartGetFitnessForEvolution(int lSystemIndex)
    {
        CurrentLSystemIndex = lSystemIndex;
        AudioListener.volume = 0f;
        isGenerating = true;
    ...
    public static float GetLevelFitness(bool hasPigs, float preScore, float timeToStable)
    {
        if (!hasPigs)
        {
            return 0f;
        ...
        {
            return 1f / (preScore + 10f * timeToStable + 1f);
        }
    }
